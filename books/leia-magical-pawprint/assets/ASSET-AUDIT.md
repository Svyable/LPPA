...
| `Leia the Princess Puppy’s Magical Pawprint.png` | unknown | Title/character/interior candidate | candidate | Import binary; record dimensions and visual content; map only after inspection. |
| `Princess Puppy’s Magical Pawprint.png` | unknown | Title/character/interior candidate | candidate | Import binary; record dimensions and visual content; map only after inspection. |
| `Leia the Princess Puppy.png` | unknown | Character/title candidate | candidate | Import binary; record dimensions; evaluate as a possible character-model reference. |
